...
function run(downloadUrl = DOWNLOAD_URL, executable = EXECUTABLE, coverageCommand = DEFAULT_COVERAGE_COMMAND) {
    return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            lastExitCode = yield exec_1.exec(executable, ['before-build']);
        ...
        try {
            lastExitCode = yield exec_1.exec(coverageCommand);
            if (lastExitCode !== 0) {
        ...
        try {
            yield exec_1.exec(executable, ['after-build', '--exit-code', lastExitCode.toString()]);
